...
export interface MMCERC721CoinInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface MMCERC721Coin extends BaseContract {
  connect(runner?: ContractRunner | null): MMCERC721Coin;
  waitForDeployment(): Promise<this>;

  interface: MMCERC721CoinInterface;
